...
class DiaryEntryTest {
    ...
    void DiaryEntry(){
        ...
        String expectedFoodItems = "[FoodItem[id=1, name=Apple, amount=1, unit=piece, calories=140, mealType=SNACK]]";
        ...
        DiaryEntry newEntry = new DiaryEntry("2024-04-09",
                List.of(new FoodItem("1","Apple", 1, "piece", 140, MealType.SNACK)),
                140);
